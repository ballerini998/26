# -*- coding: utf-8 -*-
# streamlit_app_commented.py
#
# Versione commentata del file streamlit_app.py.
# Commenti per capire: input, UI Streamlit, logica di proiezione, scenari, punti delicati.

# --- Import ---
# Streamlit = interfaccia web; pandas/numpy = calcoli; altri import = grafici o utilità.
...
# --- Lettura dati ---
# Qui carichi il file base. Deve contenere: età, popolazioni per anno base, survival per sesso,
# fertilità per età (almeno per femmine), e flussi migratori (immigration/outmigration).
...
# Funzione principale: aggiorna la popolazione anno per anno in base a survival, migrazione, nascite, aging.
# Nota: l'indentazione dei blocchi (es. età==100) è fondamentale: se è fuori dal loop dei gruppi,
# rischi di applicare correzioni solo a un gruppo.
...
# --- Nascite ---
# In genere: births = somma su età di (femmine * tasso_fecondità) / 1000 (se i tassi sono per mille).
# Poi assegni i nati all'età 0 dell'anno successivo con un sex ratio fisso.
...
# --- Open age group (100+) ---
# Regola tipica: (a) i sopravviventi dei 99 entrano nei 100, (b) i sopravviventi dei 100 restano nei 100.
# Questa correzione va fatta OGNI anno e per OGNI gruppo (maschi/femmine x italiani/stranieri).
...
# Qui definisci slider/checkbox/selectbox per scegliere scenario e parametri.
